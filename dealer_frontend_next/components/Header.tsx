        ...
        <header className="flex flex-col shadow-md">
            ...
            <div className="text-white w-full" style={{ backgroundColor: primaryColor }}>
                <div className="header-grid w-full px-4 py-1" style={{ display: 'grid', gridTemplateColumns: '1fr 5fr 1fr', alignItems: 'center', gap: '16px', minHeight: '170px' }}>
                    ...
                    <div className="flex flex-col gap-2 md:gap-3 justify-center items-center md:items-end w-full">
                        <button
                            onClick={() => window.location.href = '/inventory'}
                            className="px-4 md:px-8 py-2 md:py-4 rounded-lg font-bold text-sm md:text-lg text-gray-900 transition-all hover:shadow-lg transform hover:scale-105 shadow-lg bg-white hover:bg-gray-100 w-full md:w-auto whitespace-nowrap"
                        >
                            Shop Inventory
                        </button>
                        <button
                            onClick={() => window.location.href = '/service'}
                            className="px-4 md:px-8 py-2 md:py-4 rounded-lg font-bold text-sm md:text-lg bg-white text-gray-900 hover:bg-gray-100 shadow-lg transition-all hover:shadow-lg transform hover:scale-105 w-full md:w-auto whitespace-nowrap"
                        >
                            Schedule Service
                        </button>
                    </div>
